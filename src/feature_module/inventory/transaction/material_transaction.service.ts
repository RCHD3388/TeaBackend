...
export class MaterialTransactionService {
  ...
  async create(
    ...
    let { material, qty, transaction_category, warehouse_from, warehouse_to, price } = createMaterialTransactionInput
    ...
    try {
      ...
      // new transaction code and new date for transaction
